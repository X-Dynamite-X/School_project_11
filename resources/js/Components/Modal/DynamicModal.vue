...
<template>
    ...
    >
        <div
            class="bg-white dark:bg-gray-800 dark:text-gray-200 rounded-lg shadow-lg p-6 max-w-lg w-full border border-gray-300 dark:border-gray-700"
        >
            <!-- Header -->
